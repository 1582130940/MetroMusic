...
class LastAddedShortcutType(context: Context) : BaseShortcutType(context) {
    override val shortcutInfo: ShortcutInfo
        get() = ShortcutInfo.Builder(/* context = */ context, /* id = */ id)
            .setShortLabel(context.getString(R.string.app_shortcut_last_added_short))
            .setLongLabel(/* longLabel = */context.getString(R.string.app_shortcut_last_added_long))
            .setIcon(
                AppShortcutIconGenerator.generateThemedIcon(
                    context = context,
                    iconId = R.drawable.ic_app_shortcut_last_added
                )
